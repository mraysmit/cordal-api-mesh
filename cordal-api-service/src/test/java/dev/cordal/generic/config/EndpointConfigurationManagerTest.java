...
import dev.cordal.generic.TestConfigurationLoader;
...
class EndpointConfigurationManagerTest {
    ...
    void setUp() {
        ...
        dev.cordal.database.DatabaseManager databaseManager = new dev.cordal.database.DatabaseManager(config);
        databaseManager.initializeSchema();
        dev.cordal.database.repository.DatabaseConfigurationRepository databaseRepository = new dev.cordal.database.repository.DatabaseConfigurationRepository(databaseManager);
        dev.cordal.database.repository.QueryConfigurationRepository queryRepository = new dev.cordal.database.repository.QueryConfigurationRepository(databaseManager);
        dev.cordal.database.repository.EndpointConfigurationRepository endpointRepository = new dev.cordal.database.repository.EndpointConfigurationRepository(databaseManager);
