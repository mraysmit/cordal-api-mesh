@echo off
REM Dual PostgreSQL Integration Test Runner
REM This script runs the comprehensive dual PostgreSQL database integration test
...
if %errorlevel% equ 0 (
    ...
    echo   2. Check that ports 19080 is available
