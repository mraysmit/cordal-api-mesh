...
public class TestIsolationHelper {
     ...
     */
    public static void cleanMetricsState(MetricsApplication application) {
        if (application == null) {
            return;
        }
     ...
     */
    public static void cleanDatabaseState(MetricsApplication application) {
        if (application == null) {
            return;
        }
     ...
     */
    public static void cleanAllState(MetricsApplication application) {
     ...
     */
    public static void safeStopApplication(MetricsApplication application) {
        if (application == null) {
            return;
        }
     ...
     */
    public static void waitForApplicationReady(MetricsApplication application, long timeoutMs) {
        if (application == null) {
            return;
        }
